...
class AuthGroupModel extends Model {
    ...
    const AUTH_EXTEND_MODULE_TYPE = 2;              // 模块权限
     ...
     * @param $uid
     */
    static public function getAuthModules($uid){
        return self::getAuthExtend($uid,self::AUTH_EXTEND_MODULE_TYPE,'AUTH_MODULE');
    }
     ...
     * @param $gid
     */
    static public function getModuleOfGroup($gid){
        return self::getExtendOfGroup($gid,self::AUTH_EXTEND_MODULE_TYPE);
    }
    ...
    static public function  addToModule($gid,$mid){
        return self::addToExtend($gid,$mid,self::AUTH_EXTEND_MODULE_TYPE);
    }
     ...
     * 检查模块是否存在
     */
    public function checkModuleId($mid){
        return $this->checkId('Module',$mid, '以下模块不存在:');
    }
