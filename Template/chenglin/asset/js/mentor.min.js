$(function () {
    ...
    (function (T, S, R) {
        var Q = T.document, P = T.Modernizr, O = function (b) {
            return b.charAt(0).toUpperCase() + b.slice(1)
        }, N = "Moz Webkit O Ms".split(" "), M = function (f) {
            var d = Q.documentElement.style, j;
        ...
        }, L = M("transform"), K = M("transitionProperty"), J = {
            csstransforms: function () {
                return !!L
            }, csstransforms3d: function () {
                var b = !!M("perspective");
                if (b) {
                    var j = " -o- -moz- -ms- -webkit- -khtml- ".split(" "), i = "@media (" + j.join("transform-3d),(") + "modernizr)", h = S("<style>" + i + "{#modernizr{height:3px}}</style>").appendTo("head"), g = S('<div id="modernizr" />').appendTo("html");
        ...
        if (P.csstransforms) {
            var F = P.csstransforms3d ? {
                ...
                var s = S.data(v, "isoTransform") || {}, r = {}, q, p = {}, o;
                r[u] = t, S.extend(s, r);
                for (q in s) {
                    o = s[q], p[q] = F[q](o)
                }
            ...
            S.cssNumber.scale = !0, S.cssHooks.scale = {
                set: function (d, c) {
                    E(d, "scale", c)
                }, get: function (b, f) {
            ...
            }, S.cssNumber.translate = !0, S.cssHooks.translate = {
                set: function (d, c) {
                    E(d, "translate", c)
                }, get: function (b, f) {
                    var e = S.data(b, "isoTransform");
        ...
        B.special.smartresize = {
            setup: function () {
                ...
                f.type = "smartresize", A && clearTimeout(A), A = setTimeout(function () {
        ...
        S.Isotope.settings = {
            ...
            sortAscending: !0,
            resizesContainer: !0,
            transformsEnabled: !S.browser.opera,
            ...
            _create: function (b) {
                ...
                this.options.getSortData = S.extend(this.options.getSortData, k), this.reloadItems(), this.offset = {
                ...
                var e = this.options.itemSelector, h = e ? f.filter(e).add(f.find(e)) : f, g = {position: "absolute"};
                ...
                var d = this.options.animationEngine.toLowerCase().replace(/[ _\-]/g, ""), c;
                switch (d) {
                    case"css":
                    case"none":
                        c = !1;
                ...
                var k = this, j = this.options.getSortData, i, h;
                b.each(function () {
                    i = S(this), h = {};
                    for (var c in j) {
                ...
                var f = this.options.sortBy, e = this._getSorter, h = this.options.sortAscending ? 1 : -1, g = function (i, c) {
                    var b = e(i, f), a = e(c, f);
                ...
                this.styleQueue.push({
                    $el: f,
                    style: g
                }), this.options.itemPositionDataEnabled && f.data("isotope-item-position", {x: e, y: h})
            }, layout: function (f, e) {
                ...
                var Z = this.isLaidOut ? this.isUsingJQueryAnimation ? "animate" : "css" : "css", Y = this.options.animationOptions, X = this.options.onLayout, W, V, U, w;
                V = function (d, c) {
                    c.$el[Z](c.style, Y)
                };
                if (this._isInserting && this.isUsingJQueryAnimation) {
                    ...
                    if (aa || X || Y.complete) {
                        var v = !1, r = [aa, X, Y.complete], q = this;
                        U = !0, w = function () {
                            if (v) {
                                return
                            }
                        ...
                        if (this.isUsingJQueryAnimation && Z === "animate") {
                            ...
                            if (P.csstransitions) {
                                var e = 0, b = this.styleQueue[0], ae = b && b.$el, ad;
                                while (!ae || !ae.length) {
                ...
                var h = this, g = function () {
                    h.$allAtoms = h.$allAtoms.not(f), f.remove(), e && e.call(h.element)
                };
                f.filter(":not(." + this.options.hiddenClass + ")").length ? (this.styleQueue.push({
                    $el: f,
                    style: this.options.hiddenStyle
                }), this.$filteredAtoms = this.$filteredAtoms.not(f), this._sort(), this.reLayout(g)) : g()
            }, shuffle: function (b) {
                this.updateSortData(this.$allAtoms), this.options.sortBy = "random", this._sort(), this.reLayout(b)
            }, destroy: function () {
                var f = this.usingTransforms, e = this.options;
                ...
                var f = this.options.layoutMode, p = j ? "rowHeight" : "columnWidth", o = j ? "height" : "width", n = j ? "rows" : "cols", m = this.element[o](), l, k = this.options[f] && this.options[f][p] || this.$filteredAtoms["outer" + O(o)](!0) || m;
                l = Math.floor(m / k), l = Math.max(l, 1), this[f][n] = l, this[f][p] = k
            }, _checkIfSegmentsChanged: function (f) {
                var e = this.options.layoutMode, h = f ? "rows" : "cols", g = this[e][h];
                ...
                var f = this, e = f.masonry;
                b.each(function () {
                    var c = S(this), m = Math.ceil(c.outerWidth(!0) / e.columnWidth);
                    m = Math.min(m, e.cols);
                    if (m === 1) {
                        f._masonryPlaceBrick(c, e.colYs)
                    } else {
                        var l = e.cols + 1 - m, k = [], j, d;
                        for (d = 0; d < l; d++) {
                ...
                var r = Math.min.apply(Math, s), q = 0;
                ...
                var h = this, g = this.element.width(), f = this.fitRows;
                b.each(function () {
                    var c = S(this), e = c.outerWidth(!0), d = c.outerHeight(!0);
                ...
                var f = this, e = this.cellsByRow;
                b.each(function () {
                    var c = S(this), k = e.index % e.cols, j = Math.floor(e.index / e.cols), i = (k + 0.5) * e.columnWidth - c.outerWidth(!0) / 2, d = (j + 0.5) * e.rowHeight - c.outerHeight(!0) / 2;
                ...
                var f = this, e = f.masonryHorizontal;
                b.each(function () {
                    var c = S(this), m = Math.ceil(c.outerHeight(!0) / e.rowHeight);
                    m = Math.min(m, e.rows);
                    if (m === 1) {
                        f._masonryHorizontalPlaceBrick(c, e.rowXs)
                    } else {
                        var l = e.rows + 1 - m, k = [], j, d;
                        for (d = 0; d < l; d++) {
                ...
                var h = this, g = this.element.height(), f = this.fitColumns;
                b.each(function () {
                    var c = S(this), e = c.outerWidth(!0), d = c.outerHeight(!0);
                ...
                var f = this, e = this.cellsByColumn;
                b.each(function () {
                    var c = S(this), k = Math.floor(e.index / e.rows), j = e.index % e.rows, i = (k + 0.5) * e.columnWidth - c.outerWidth(!0) / 2, d = (j + 0.5) * e.rowHeight - c.outerHeight(!0) / 2;
                    f._pushPosition(c, i, d), e.index++
                })
    ...
    !function (b) {
        b(function () {
            "use strict", b.support.transition = function () {
                var a = document.body || document.documentElement, f = a.style, e = f.transition !== undefined || f.WebkitTransition !== undefined || f.MozTransition !== undefined || f.MsTransition !== undefined || f.OTransition !== undefined;
                return e && {
                    end: function () {
                        var c = "TransitionEnd";
        ...
        var d = '[data-dismiss="alert"]', f = function (a) {
            e(a).on("click", d, this.close)
        };
        f.prototype = {
            constructor: f, close: function (a) {
                function g() {
                    h.trigger("closed").remove()
                }

                var j = e(this), i = j.attr("data-target"), h;
                i || (i = j.attr("href"), i = i && i.replace(/.*(?=#[^\s]*$)/, "")), h = e(i), h.trigger("close"), a && a.preventDefault(), h.length || (h = j.hasClass("alert") ? j : j.parent()), h.trigger("close").removeClass("in"), e.support.transition && h.hasClass("fade") ? h.on(e.support.transition.end, g) : g()
            }
        }, e.fn.alert = function (a) {
            return this.each(function () {
                var c = e(this), b = c.data("alert");
                b || c.data("alert", b = new f(this)), typeof a == "string" && b[a].call(c)
            })
        }, e.fn.alert.Constructor = f, e(function () {
            e("body").on("click.alert.data-api", d, f.prototype.close)
        })
    }(window.jQuery), !function (d) {
        var c = function (a, e) {
            this.$element = d(a), this.options = d.extend({}, d.fn.button.defaults, e)
        };
        c.prototype = {
            constructor: c, setState: function (g) {
                var f = "disabled", j = this.$element, i = j.data(), h = j.is("input") ? "val" : "html";
                g += "Text", i.resetText || j.data("resetText", j[h]()), j[h](i[g] || this.options[g]), setTimeout(function () {
                    g == "loadingText" ? j.addClass(f).attr(f, f) : j.removeClass(f).removeAttr(f)
                }, 0)
            }, toggle: function () {
            ...
            return this.each(function () {
                var h = d(this), g = h.data("button"), b = typeof a == "object" && a;
                g || h.data("button", g = new c(this, b)), a == "toggle" ? g.toggle() : a && g.setState(a)
            })
        }, d.fn.button.defaults = {loadingText: "loading..."}, d.fn.button.Constructor = c, d(function () {
            d("body").on("click.button.data-api", "[data-toggle^=button]", function (a) {
                var e = d(a.target);
        ...
        var c = function (a, e) {
            this.$element = d(a), this.options = d.extend({}, d.fn.carousel.defaults, e), this.options.slide && this.slide(this.options.slide), this.options.pause == "hover" && this.$element.on("mouseenter", d.proxy(this.pause, this)).on("mouseleave", d.proxy(this.cycle, this))
        };
        c.prototype = {
            cycle: function () {
                return this.interval = setInterval(d.proxy(this.next, this), this.options.interval), this
            }, to: function (a) {
                var j = this.$element.find(".active"), i = j.parent().children(), h = i.index(j), g = this;
                if (a > i.length - 1 || a < 0) {
                    return
                }
                ...
                var o = this.$element.find(".active"), n = p || o[a](), m = this.interval, l = a == "next" ? "left" : "right", k = a == "next" ? "first" : "last", j = this;
                this.sliding = !0, m && this.pause(), n = n.length ? n : this.$element.find(".item")[k]();
                if (n.hasClass("active")) {
                    return
                }
                return !d.support.transition && this.$element.hasClass("slide") ? (this.$element.trigger("slide"), o.removeClass("active"), n.addClass("active"), this.sliding = !1, this.$element.trigger("slid")) : (n.addClass(a), n[0].offsetWidth, o.addClass(l), n.addClass(l), this.$element.trigger("slide"), this.$element.one(d.support.transition.end, function () {
                    n.removeClass([a, l].join(" ")).addClass("active"), o.removeClass(["active", l].join(" ")), j.sliding = !1, setTimeout(function () {
            ...
            return this.each(function () {
                var h = d(this), g = h.data("carousel"), b = typeof a == "object" && a;
                g || h.data("carousel", g = new c(this, b)), typeof a == "number" ? g.to(a) : typeof a == "string" || (a = b.slide) ? g[a]() : g.cycle()
            })
        }, d.fn.carousel.defaults = {interval: 5000, pause: "hover"}, d.fn.carousel.Constructor = c, d(function () {
            d("body").on("click.carousel.data-api", "[data-slide]", function (a) {
                var j = d(this), i, h = d(j.attr("data-target") || (i = j.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, "")), g = !h.data("modal") && d.extend({}, h.data(), j.data());
                h.carousel(g), a.preventDefault()
            })
        })
    }(window.jQuery), !function (d) {
        var c = function (a, e) {
            this.$element = d(a), this.options = d.extend({}, d.fn.collapse.defaults, e), this.options.parent && (this.$parent = d(this.options.parent)), this.options.toggle && this.toggle()
        };
        c.prototype = {
            constructor: c, dimension: function () {
                var b = this.$element.hasClass("width");
                return b ? "width" : "height"
            }, show: function () {
                var a = this.dimension(), h = d.camelCase(["scroll", a].join("-")), g = this.$parent && this.$parent.find(".in"), f;
                ...
                return this.$element.removeClass("collapse")[e](f || "auto")[0].offsetWidth, this.$element[f ? "addClass" : "removeClass"]("collapse"), this
            }, transition: function (a, j, i) {
                var h = this, g = function () {
                    j == "show" && h.reset(), h.$element.trigger(i)
                };
            ...
            return this.each(function () {
                var h = d(this), g = h.data("collapse"), b = typeof a == "object" && a;
                g || h.data("collapse", g = new c(this, b)), typeof a == "string" && g[a]()
            })
        }, d.fn.collapse.defaults = {toggle: !0}, d.fn.collapse.Constructor = c, d(function () {
            d("body").on("click.collapse.data-api", "[data-toggle=collapse]", function (a) {
                var j = d(this), i, h = j.attr("data-target") || a.preventDefault() || (i = j.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, ""), g = d(h).data("collapse") ? "toggle" : j.data();
                d(h).collapse(g)
            })
        })
    }(window.jQuery), !function (f) {
        function g() {
            f(e).parent().removeClass("open")
        }

        "use strict";
        var e = '[data-toggle="dropdown"]', h = function (a) {
            var d = f(a).on("click.dropdown.data-api", this.toggle);
            f("html").on("click.dropdown.data-api", function () {
                d.parent().removeClass("open")
            })
        };
        h.prototype = {
            constructor: h, toggle: function (a) {
                var k = f(this), j = k.attr("data-target"), i, d;
                return j || (j = k.attr("href"), j = j && j.replace(/.*(?=#[^\s]*$)/, "")), i = f(j), i.length || (i = k.parent()), d = i.hasClass("open"), g(), !d && i.toggleClass("open"), !1
            }
        }, f.fn.dropdown = function (a) {
            return this.each(function () {
                var c = f(this), b = c.data("dropdown");
                b || c.data("dropdown", b = new h(this)), typeof a == "string" && b[a].call(c)
            })
        }, f.fn.dropdown.Constructor = h, f(function () {
            f("html").on("click.dropdown.data-api", g), f("body").on("click.dropdown.data-api", e, h.prototype.toggle)
        })
    }(window.jQuery), !function (i) {
        function n() {
            var a = this, d = setTimeout(function () {
                a.$element.off(i.support.transition.end), m.call(a)
            }, 500);
            this.$element.one(i.support.transition.end, function () {
                clearTimeout(d), m.call(a)
            })
        }
        ...
        function l(a) {
            var o = this, g = this.$element.hasClass("fade") ? "fade" : "";
            if (this.isShown && this.options.backdrop) {
                var f = i.support.transition && g;
                ...
                !this.isShown && this.$backdrop ? (this.$backdrop.removeClass("in"), i.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(i.support.transition.end, i.proxy(k, this)) : k.call(this)) : a && a()
            }
        }
        ...
        function j() {
            var a = this;
            this.isShown && this.options.keyboard ? i(document).on("keyup.dismiss.modal", function (b) {
                b.which == 27 && a.hide()
        ...
        "use strict";
        var h = function (a, d) {
            this.options = d, this.$element = i(a).delegate('[data-dismiss="modal"]', "click.dismiss.modal", i.proxy(this.hide, this))
        };
        h.prototype = {
            constructor: h, toggle: function () {
                ...
                i("body").addClass("modal-open"), this.isShown = !0, this.$element.trigger("show"), j.call(this), l.call(this, function () {
                    var b = i.support.transition && a.$element.hasClass("fade");
                    !a.$element.parent().length && a.$element.appendTo(document.body), a.$element.show(), b && a.$element[0].offsetWidth, a.$element.addClass("in"), b ? a.$element.one(i.support.transition.end, function () {
                ...
                var c = this;
                this.isShown = !1, i("body").removeClass("modal-open"), j.call(this), this.$element.trigger("hide").removeClass("in"), i.support.transition && this.$element.hasClass("fade") ? n.call(this) : m.call(this)
            }
        }, i.fn.modal = function (a) {
            return this.each(function () {
                var g = i(this), c = g.data("modal"), b = i.extend({}, i.fn.modal.defaults, g.data(), typeof a == "object" && a);
                c || g.data("modal", c = new h(this, b)), typeof a == "string" ? c[a]() : b.show && c.show()
            })
        }, i.fn.modal.defaults = {backdrop: !0, keyboard: !0, show: !0}, i.fn.modal.Constructor = h, i(function () {
            i("body").on("click.modal.data-api", '[data-toggle="modal"]', function (a) {
                var q = i(this), p, o = i(q.attr("data-target") || (p = q.attr("href")) && p.replace(/.*(?=#[^\s]+$)/, "")), g = o.data("modal") ? "toggle" : i.extend({}, o.data(), q.data());
        ...
        c.prototype = {
            constructor: c, init: function (a, j, i) {
                var h, g;
                ...
                return a = d.extend({}, d.fn[this.type].defaults, a, this.$element.data()), a.delay && typeof a.delay == "number" && (a.delay = {
                    show: a.delay,
                    hide: a.delay
                }), a
            }, enter: function (a) {
                var e = d(a.currentTarget)[this.type](this._options).data(this.type);
                ...
                if (this.hasContent() && this.enabled) {
                    i = this.tip(), this.setContent(), this.options.animation && i.addClass("fade"), k = typeof this.options.placement == "function" ? this.options.placement.call(this, i[0], this.$element[0]) : this.options.placement, h = /in/.test(k), i.remove().css({
                        top: 0,
                        left: 0,
                        display: "block"
                    }).appendTo(h ? this.$element : document.body), n = this.getPosition(h), m = i[0].offsetWidth, l = i[0].offsetHeight;
                    switch (h ? k.split(" ")[1] : k) {
                        case"bottom":
                            j = {top: n.top + n.height, left: n.left + n.width / 2 - m / 2};
                            break;
                        case"top":
                            j = {top: n.top - l, left: n.left + n.width / 2 - m / 2};
                            break;
                        case"left":
                            j = {top: n.top + n.height / 2 - l / 2, left: n.left - m};
                            break;
                        case"right":
                            j = {top: n.top + n.height / 2 - l / 2, left: n.left + n.width}
                    }
                ...
                function e() {
                    var g = setTimeout(function () {
                        f.off(d.support.transition.end).remove()
                    }, 500);
                    f.one(d.support.transition.end, function () {
                        clearTimeout(g), f.remove()
                    })
                }
                ...
                return d.extend({}, a ? {top: 0, left: 0} : this.$element.offset(), {
                    width: this.$element[0].offsetWidth,
                    height: this.$element[0].offsetHeight
                })
            }, getTitle: function () {
                var f, e = this.$element, g = this.options;
                return f = e.attr("data-original-title") || (typeof g.title == "function" ? g.title.call(e[0]) : g.title), f = (f || "").toString().replace(/(^\s*|\s*$)/, ""), f
            }, tip: function () {
            ...
            return this.each(function () {
                var h = d(this), g = h.data("tooltip"), b = typeof a == "object" && a;
                g || h.data("tooltip", g = new c(this, b)), typeof a == "string" && g[a]()
            })
        }, d.fn.tooltip.Constructor = c, d.fn.tooltip.defaults = {
            animation: !0,
            delay: 0,
            selector: !1,
            placement: "top",
        ...
        c.prototype = d.extend({}, d.fn.tooltip.Constructor.prototype, {
            constructor: c, setContent: function () {
                var a = this.tip(), f = this.getTitle(), e = this.getContent();
            ...
            return this.each(function () {
                var h = d(this), g = h.data("popover"), b = typeof a == "object" && a;
                g || h.data("popover", g = new c(this, b)), typeof a == "string" && g[a]()
            })
        }, d.fn.popover.Constructor = c, d.fn.popover.defaults = d.extend({}, d.fn.tooltip.defaults, {
            placement: "right",
            content: "",
        ...
        function c(a, j) {
            var i = d.proxy(this.process, this), h = d(a).is("body") ? d(window) : d(a), g;
        ...
        "use strict", c.prototype = {
            constructor: c, refresh: function () {
                this.targets = this.$body.find(this.selector).map(function () {
                    var a = d(this).attr("href");
                    return /^#\w/.test(a) && d(a).length ? a : null
                }), this.offsets = d.map(this.targets, function (a) {
                    return d(a).position().top
                })
            }, process: function () {
                var g = this.$scrollElement.scrollTop() + this.options.offset, f = this.offsets, j = this.targets, i = this.activeTarget, h;
                for (h = f.length; h--;) {
                    i != j[h] && g >= f[h] && (!f[h + 1] || g <= f[h + 1]) && this.activate(j[h])
                }
            }, activate: function (f) {
                var e;
            ...
            return this.each(function () {
                var h = d(this), g = h.data("scrollspy"), b = typeof a == "object" && a;
                g || h.data("scrollspy", g = new c(this, b)), typeof a == "string" && g[a]()
            })
        }, d.fn.scrollspy.Constructor = c, d.fn.scrollspy.defaults = {offset: 10}, d(function () {
        ...
        c.prototype = {
            constructor: c, show: function () {
                var a = this.element, j = a.closest("ul:not(.dropdown-menu)"), i = a.attr("data-target"), h, g;
                i || (i = a.attr("href"), i = i && i.replace(/.*(?=#[^\s]*$)/, ""));
                if (a.parent("li").hasClass("active")) {
                    return
                }
                h = j.find(".active a").last()[0], a.trigger({
                    type: "show",
                    relatedTarget: h
                }), g = d(i), this.activate(a.parent("li"), j), this.activate(g, g.parent(), function () {
                    a.trigger({type: "shown", relatedTarget: h})
                })
            ...
            return this.each(function () {
                var f = d(this), b = f.data("tab");
                b || f.data("tab", b = new c(this)), typeof a == "string" && b[a]()
            })
        }, d.fn.tab.Constructor = c, d(function () {
            d("body").on("click.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"]', function (a) {
                a.preventDefault(), d(this).tab("show")
            })
        })
    }(window.jQuery), !function (d) {
        var c = function (a, e) {
            this.$element = d(a), this.options = d.extend({}, d.fn.typeahead.defaults, e), this.matcher = this.options.matcher || this.matcher, this.sorter = this.options.sorter || this.sorter, this.highlighter = this.options.highlighter || this.highlighter, this.$menu = d(this.options.menu).appendTo("body"), this.source = this.options.source, this.shown = !1, this.listen()
        };
        c.prototype = {
            constructor: c, select: function () {
                var b = this.$menu.find(".active").attr("data-value");
                return this.$element.val(b), this.$element.change(), this.hide()
            }, show: function () {
                var a = d.extend({}, this.$element.offset(), {height: this.$element[0].offsetHeight});
                return this.$menu.css({top: a.top + a.height, left: a.left}), this.$menu.show(), this.shown = !0, this
            }, hide: function () {
                return this.$menu.hide(), this.shown = !1, this
            }, lookup: function (a) {
                var h = this, g, f;
                return this.query = this.$element.val(), this.query ? (g = d.grep(this.source, function (b) {
                    if (h.matcher(b)) {
                        return b
                    }
                ...
                var f = [], j = [], i = [], h;
                while (h = g.shift()) {
                    h.toLowerCase().indexOf(this.query.toLowerCase()) ? ~h.indexOf(this.query) ? j.push(h) : i.push(h) : f.push(h)
                }
                return f.concat(j, i)
            }, highlighter: function (b) {
                return b.replace(new RegExp("(" + this.query + ")", "ig"), function (f, e) {
                    return "<strong>" + e + "</strong>"
                })
            }, render: function (a) {
                var e = this;
                return a = d(a).map(function (f, g) {
                    return f = d(e.options.item).attr("data-value", g), f.find("a").html(e.highlighter(g)), f[0]
                }), a.first().addClass("active"), this.$menu.html(a), this
            }, next: function (a) {
                var f = this.$menu.find(".active").removeClass("active"), e = f.next();
                e.length || (e = d(this.$menu.find("li")[0])), e.addClass("active")
            }, prev: function (f) {
                var e = this.$menu.find(".active").removeClass("active"), g = e.prev();
                g.length || (g = this.$menu.find("li").last()), g.addClass("active")
            }, listen: function () {
                this.$element.on("blur", d.proxy(this.blur, this)).on("keypress", d.proxy(this.keypress, this)).on("keyup", d.proxy(this.keyup, this)), (d.browser.webkit || d.browser.msie) && this.$element.on("keydown", d.proxy(this.keypress, this)), this.$menu.on("click", d.proxy(this.click, this)).on("mouseenter", "li", d.proxy(this.mouseenter, this))
            }, keyup: function (b) {
                switch (b.keyCode) {
                    case 40:
                    case 38:
                ...
                this.$menu.find(".active").removeClass("active"), d(a.currentTarget).addClass("active")
            }
        }, d.fn.typeahead = function (a) {
            return this.each(function () {
                var h = d(this), g = h.data("typeahead"), b = typeof a == "object" && a;
            ...
            item: '<li><a href="#"></a></li>'
        }, d.fn.typeahead.Constructor = c, d(function () {
            d("body").on("focus.typeahead.data-api", '[data-provide="typeahead"]', function (a) {
                var e = d(this);
                if (e.data("typeahead")) {
                    return
                }
                ...
                this.getMediaContainer = function () {
                    ...
                    if (this.env.mediaContainer.length == 0) {
                        if (this.env.playerDom.find("." + this.config._cssClassPrefix + "display").length > 0) {
                            this.env.mediaContainer = $(document.createElement("div")).attr({id: this.getId() + "_media"}).css({
                                overflow: "hidden",
                                height: "100%",
                                width: "100%",
                                top: 0,
                            ...
                            this.env.mediaContainer = $(document.createElement("div")).attr({id: this.getMediaId()}).css({
                                width: "1px",
                                height: "1px"
    ...
    jQuery(function (b) {
        $p.newModel({
            modelId: "NA",
            iLove: [{ext: "NaN", type: "none/none", platform: "all"}],
            hasGUI: true,
    ...
    jQuery(function (b) {
        $p.newModel({
            modelId: "PLAYLIST",
            iLove: [{ext: "json", type: "text/json", platform: "internal"}, {
                ext: "jsonp",
                type: "text/jsonp",
                platform: "internal"
    ...
    jQuery(function (b) {
        $p.newModel({
            modelId: "VIDEOFLASH",
            iLove: [{ext: "flv", type: "video/x-flv", platform: "flash", fixed: true}, {
                ext: "flv",
                type: "video/flv",
                platform: "flash",
                fixed: true
        ...
        $p.newModel({
            modelId: "AUDIOFLASH",
            iLove: [{ext: "mp3", type: "audio/mp3", platform: "flash"}, {
                ext: "mp3",
                type: "audio/mpeg",
                platform: "flash"
    ...
    jQuery(function (b) {
        $p.newModel({
            modelId: "VIDEO",
            iLove: [{ext: "ogv", type: "video/ogg", platform: "native"}, {
                ext: "webm",
                type: "video/webm",
                platform: "native"
        ...
        $p.newModel({
            modelId: "AUDIO",
            iLove: [{ext: "ogg", type: "audio/ogg", platform: "native"}, {
                ext: "oga",
                type: "audio/ogg",
                platform: "native"
    ...
    jQuery(function (b) {
        $p.newModel({
            modelId: "IMAGE",
            iLove: [{ext: "jpg", type: "image/jpeg", platform: "all"}, {
                ext: "gif",
                type: "image/gif",
                platform: "all"
        ...
        $p.newModel({
            modelId: "HTML",
            iLove: [{ext: "html", type: "text/html", platform: "all"}],
            applyMedia: function (d) {
                ...
                this.mediaElement = b(document.createElement("iframe")).attr({
                    ...
                    width: "100%",
                    height: "100%"
                }).css({overflow: "hidden", border: "0px", width: "100%", height: "100%"}).appendTo(d);
    ...
    jQuery(function (b) {
        $p.newModel({
            modelId: "YTVIDEO",
            iLove: [{ext: "youtube.com", type: "video/youtube", platform: "flash", fixed: true}],
            modelReady: false,
            allowRandomSeek: true,
            useIframeAPI: true,
            _updateTimer: null,
            ...
            applyMedia: function (f) {
                ...
                if (this.useIframeAPI === true) {
                    this.mediaElement = new YT.Player(this.pp.getId() + "_media", {
                        ...
                        playerVars: {autoplay: 0, disablekb: 1, start: 0, controls: 0, enablejsapi: 1, wmode: "opaque"},
                    ...
                    b(this.mediaElement.a).prop("ALLOWTRANSPARENCY", true).attr({
                        scrolling: "no",
                        frameborder: 0
                    }).css({overflow: "hidden", border: "0px", display: "block"});
                    if (b.browser.mozilla) {
                        this.requiresFlash = 8
                    }
                } else {
                    var e = {
                        ...
                        allowScriptAccess: "always",
                        wmode: "transparent",
                        FlashVars: {enablejsapi: 1, autoplay: 1}
                    };
                    this.createFlash(e, f)
                }
            },
    ...
    jQuery(function (b) {
        projekktorControlbar.prototype = {
            ...
            controlElementsConfig: {
                ...
                loaded: {on: "click", call: "scrubberClk"},
                scrubber: {on: "click", call: "scrubberClk"},
                play: {on: "click", call: "playClk"},
                pause: {on: "click", call: "pauseClk"},
                stop: {on: "click", call: "stopClk"},
                prev: {on: "click", call: "prevClk"},
                next: {on: "click", call: "nextClk"},
                rewind: {on: "click", call: "rewindClk"},
                forward: {on: "click", call: "forwardClk"},
                fsexit: {on: "click", call: "exitFullscreenClk"},
                fsenter: {on: "click", call: "enterFullscreenClk"},
                vslider: {on: "click", call: "vsliderClk"},
                vmarker: {on: "click", call: "vsliderClk"},
                vknob: {on: "mousedown", call: "vknobStartDragListener"},
                mute: {on: "click", call: "muteClk"},
                unmute: {on: "click", call: "unmuteClk"},
                vmax: {on: "click", call: "vmaxClk"},
                open: {on: "click", call: "openCloseClk"},
                close: {on: "click", call: "openCloseClk"},
                loopon: {on: "click", call: "loopClk"},
                loopoff: {on: "click", call: "loopClk"},
                draghandle: {on: "mousedown", call: "handleStartDragListener"},
                controls: {on: null, call: null},
                title: null,
                sec_dur: null,
                min_dur: null,
                hr_dur: null,
    ...
    (function (d) {
        ...
        d.pixelentity.video = {
            conf: {disableFade: false, useVideoTag: false}, getType: function (f) {
    ...
    (function (f) {
        ...
        function e(C, m) {
            ...
            f.extend(this, {
                enable: o, disable: i, destroy: function () {
                    if (y && y.destroy) {
                        y.destroy()
                    }
                    y = undefined;
    ...
    (function (d) {
        ...
        function e() {
            ...
            var x = false;
            var ao = false;
            var m = d.support.csstransitions;
            var aG = d.support.csstransitionsEnd;
            var af, K;
            var au = [];
            var aq = [];
            var I = {};
            ...
            function r() {
                O = V.width();
                W = window.innerHeight ? window.innerHeight : V.height();
                if (az) {
                    az.width(O).height(W)
                }
                if (d.pixelentity.browser.mobile && ak && ak.data("count") > 0) {
                    at(A, true)
                }
                var h = ar.length;
                while (h--) {
            ...
            function ab(w) {
                ...
                if (aR >= 0) {
                    aS = -aR * aS / O;
                    aQ.css("margin-left", aS)
                } else {
                    aQ.css("margin-left", "auto")
                }
            }

            function at(aU, aT) {
                var h = ak.data("size");
                var w = Math.floor(O / h);
                var aS;
                var aR = 0;
                if (ak.data("width") > O) {
                    if (aT) {
            ...
            function y(aR) {
                ...
                switch (w) {
                    case"touchstart":
                        if (aS.touches.length > 1 || aS.scale && aS.scale !== 1) {
                            return true
                        }
                        aC = aS.touches[0].pageX;
                        C = 0;
                        break;
                    case"touchmove":
                        if (aS.touches.length > 1 || aS.scale && aS.scale !== 1) {
                        ...
                        C = (aS.touches[0].pageX - aC);
                        aR.preventDefault();
                        aR.stopPropagation();
                        if (ae) {
                            aQ.addClass("touchMove").transform(1, aj + C, 0)
                        }
                        break;
                    case"touchend":
                        if (ae) {
                            aQ.removeClass("touchMove")
                        }
                        if (C === 0) {
                            return false
                        }
            ...
            function M() {
                ...
                aB = "prev";
                l(aJ[P === 0 ? aJ.length - 1 : P - 1])
            }

            function aF(h) {
                var w = ak.parent();
                ae = h === true ? true : (h === false ? false : (ae ? false : true));
                if (aG) {
                    w[ae ? "addClass" : "removeClass"]("peFlareLightboxActive")
                } else {
                    w.animate({"margin-top": (ae ? -84 : 0)}, 500)
                }
            }

            function ay() {
                if (v.hasClass("peFlareLightboxActive")) {
                    if (d.pixelentity.browser.mobile || j.videoType == "youtube" || j.videoType == "vimeo") {
                        var h = d.pixelentity.browser.iDev ? 35 : 0;
                        var w = d.pixelentity.browser.android ? O * 9 / 16 : W;
                        w = Math.min(w, W);
                        v.find("iframe, video").css("margin-top", (W - w) / 2 + h).height(w - h).width("100%")
                    } else {
                        aM.resize(O, W)
                    }
                }
            ...
            function ag() {
                clearTimeout(Q);
                aM.unbind("video_ready.pixelentity", ag);
                af.hide();
                v.addClass("peFlareLightboxActive");
                ay()
            }
            ...
            function s() {
                ...
                if (aM) {
                    ...
                    aM = false;
                    v.removeClass("peFlareLightboxActive").empty();
                    ad.addClass("peFlareLightboxActive")
                }
            }
            ...
            function Z() {
                af.show();
                ad.removeClass("peFlareLightboxActive");
                aM = v.peVideo({
                    api: true,
                ...
                aM.one("video_ready.pixelentity", ag);
                Q = setTimeout(ag, 5000)
            }
            ...
            function G() {
                ...
                t = true;
                V = d(window).resize(r);
                az = d('<div class="peFlareLightbox"><div class="peFlareLightboxHidden"></div><div class="peFlareLightboxControls"><div><a href="#" class="sprite" id="peFlareLightboxControlClose"/><a href="#" class="sprite" id="peFlareLightboxControlNext"/><a href="#" class="sprite" id="peFlareLightboxControlPrev"/><a href="#" class="sprite" id="peFlareLightboxControlThumbs"/></div></div><div class="peFlareLightboxOverlay"></div><div class="peFlareLightboxContent"></div><div class="peFlareLightboxThumbs"><span></span></div><a id="peFlareLightboxControlVideo" class="peFlareLightboxVideoIcon"><span></span></a><div class="peFlareLightboxVideo"></div><div class="peFlareLightboxSpinner"><span/></div></div>');
                if (!m) {
                    az.addClass("no-transitions")
                }
                if (d.browser.msie) {
                    az.addClass("msie")
                }
                d("body").append(az).bind("touchmove", R);
                af = az.find(".peFlareLightboxSpinner").hide();
                K = az.find(".peFlareLightboxContent");
                ad = az.find(".peFlareLightboxVideoIcon");
                v = az.find(".peFlareLightboxVideo");
                ak = d("<div/>");
                if (d.pixelentity.browser.mobile) {
                    az.addClass("mobile");
                    az.find(".peFlareLightboxThumbs").append(ak)
                } else {
                    az.find(".peFlareLightboxThumbs").bind("mouseenter mouseleave", n).append(ak)
                }
                L = az.find(".peFlareLightboxHidden");
                az.bind("touchstart touchmove touchend", y).bind("mousewheel", X).delegate(".peFlareLightboxControls a", "click touchstart", aN).delegate(".peFlareLightboxThumbs span", "click", n);
                ad.click(aN);
                if (!d.pixelentity.browser.mobile) {
                    ak.bind("mousemove", ab)
                } else {
                    az.click(aF)
                }
                d(document).bind("keydown", X)
            }
            ...
            function am() {
                az.addClass("peFlareLightboxActive");
                if (m) {
                    setTimeout(u, 600)
                } else {
                    az.stop().css("opacity", 0).fadeTo(500, 1, u)
                }
            }
            ...
            function ap() {
                ...
                ak.data("created", false).empty();
                az.removeClass("peFlareLightboxActive");
                ad.removeClass("peFlareLightboxActive");
                aB = "none"
            }
            ...
            function Y(h) {
                ...
                if (m) {
                    ...
                    az.stop().css("opacity", 1).fadeTo(500, 0, ap)
                }
            }
            ...
            function N() {
                ...
                for (var aR = 0; aR < aJ.length; aR++) {
                    aT = aJ[aR];
                    if ((w = aA[aT].thumb)) {
                        w = d("<span/>").attr("data-src", w).attr("id", aT);
                        aQ.append(w);
                        w.peSimpleThumb();
                        aS++
                    }
                ...
                ak.data("size", 104);
                if (aS > 0) {
                    ak.data("created", true);
                    ak.data("width", h)
                } else {
                    az.find("#peFlareLightboxControlThumbs").hide()
                }
            }
            ...
            function p(h) {
                aK();
                var w = T;
                aA[w].resource = (h && h[0] && h[0].thumbnail_large) || false;
                T = -1;
                l(w)
            }
            ...
            function l(aT) {
                var aR = aA[aT];
                if (aR.resource.match(g)) {
                    T = aT;
                    F();
                    d.getJSON(aR.resource, p);
                    return false
                }
                if (aT === T) {
                    ao = true;
                ...
                T = aT;
                s();
                aJ = aR.gallery ? aw[aR.gallery] : false;
                aJ = aJ.length > 1 ? aJ : false;
                az.find("#peFlareLightboxControlPrev,#peFlareLightboxControlNext,#peFlareLightboxControlThumbs")[aJ && aJ.length > 1 ? "show" : "hide"]();
                if (aJ) {
                    P = d.inArray(aT, aJ);
                    N()
                }
                ...
                var w;
                var aS, h;
                if (aq.length > 0 && (aS = I[aq[0]]).isGallery) {
                    w = aq[0];
                    aO = false
                } else {
                    w = J++;
                    h = au[aR.plugin] || au["default"];
                    aS = new h(w, O, W);
                    I[w] = aS;
                    aq.push(w);
                    aO = true
            ...
            function q(aR) {
                var w = I[aR];
                var h = w.resize(O, W).render();
                if (w.isGallery) {
                    K.append(h)
                } else {
                    h.css("left", f[aB].from);
                    K.append(h);
                    if (m) {
                        h.fadeTo(0, 1).css("left", f[aB].to)
                    } else {
                        h.css("opacity", 0).animate({left: f[aB].to, opacity: 1}, 1000)
                    }
                }
                if (d.inArray(w, ar) < 0) {
                    ar.push(w)
                ...
                if (j && !aJ) {
                    ...
                    ad[j ? "addClass" : "removeClass"]("peFlareLightboxActive")
                }
            }
            ...
            function D() {
                ...
                while ((w = ar.shift())) {
                    if (aG) {
                        w.render().fadeTo(0, 0).css("left", -f[aB].from).one(aG, w.destroy)
                    } else {
                        w.render().css("opacity", 1).animate({left: -f[aB].from, opacity: 0}, 1000, null, w.destroy)
                    }
                }
            }
            ...
            function ax(w) {
                ...
                var aR = w.id !== undefined ? w.id : aA.length;
                if (h) {
                    if (aw[h]) {
                        aw[h].push(aR)
                    } else {
            ...
            function B(aT) {
                var aU = k.length;
                var aR = aT.attr("href");
                var w = aT.attr("data-flare-plugin") || "default";
                aT.attr("data-pe-target-id", k.length).bind("click", E);
                var aS;
                aS = d.pixelentity.videoplayer.getInfo(aR, aT.attr("data-flare-videoformats"), aT.attr("data-flare-videoposter"));
                if (aS.video) {
                    aR = aS.videoPoster
                } else {
                    aS = d.pixelentity.videoplayer.getInfo(aT.attr("data-flare-video"), aT.attr("data-flare-videoformats"))
                }
                var h = {
                    id: aU,
                    plugin: w,
                    resource: aR || "",
                    gallery: aT.attr("data-flare-gallery") || false,
                    bw: aT.attr("data-flare-bw"),
                    thumb: aT.attr("data-flare-thumb"),
                    scale: aT.attr("data-flare-scale") || "fit"
                };
                if (aS.video) {
                    d.extend(h, aS)
                }
            ...
            d.extend(this, {init: al, add: B, show: q, signal: o, register: aL, addToBuffer: z})
        }
    ...
    (function (f) {
        f.pixelentity = f.pixelentity || {version: "1.0.0"};
        f.pixelentity.peVolo = {conf: {api: false, count: 1, transition: 500}};
        f.extend(f.easing, {
            easeOutQuad: function (m, n, i, p, o) {
                return p * ((n = n / o - 1) * n * n + 1) + i
            }
        });
        var a = document.createElement("div").style;
        var j, g = ["O", "ms", "Webkit", "Moz"];
        var k, h, c = false, d = false, l = false;
        ...
        if (!d) {
            h = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (i) {
                setTimeout(i, 25)
            }
        }
        function b(i, V) {
            ...
            function K() {
                R = true;
                var ae = (i.attr("data-height") || "").split(/,| /);
                if (ae[0]) {
                    aa = parseInt(ae[0], 10)
                }
                if (ae[1]) {
                    n = ae[1] === "auto" ? "auto" : parseFloat(ae[1], 10)
                }
                if (ae[2]) {
                    P = parseInt(ae[2], 10)
                }
                if (n === 0) {
                    ...
                    if (n === "auto") {
                        ...
                        if (w.length > 0) {
                            n = (w[0].naturalWidth / w[0].naturalHeight) * A
                        } else {
                            n = 0
                        }
                    }
                }
                x = i.attr("data-slidewidth");
                if (x) {
                    V.slideWidth = parseInt(x, 10)
                }
                F = i.find("> div:eq(0)");
                var ad = F.find("> div").each(v);
                C = F[0].style;
                H = t.length;
                B();
                F.css("visibility", "visible");
                ad.css("visibility", "visible").show();
                f(window).bind("resize", X);
                i.bind("touchstart touchmove touchend", q);
                if (i.attr("data-autopause") !== "disabled") {
                    i.bind("mouseenter mouseleave", Y)
                }
                if (d) {
                    i.bind(j.toLowerCase() + "TransitionEnd transitionend", G)
                }
                G();
                setTimeout(ab, 100);
                return true
            ...
            function ab() {
                i.trigger("ready.pixelentity", {slides: t.length})
            }
            ...
            function B(ag) {
                ...
                ag = typeof ag === "undefined" ? i.width() : ag;
                if (ag === S) {
                    return
                }
                S = ag;
                ...
                for (var af = 0; af < H; af++) {
                    ...
                    if (w.hasClass("scale")) {
                        ...
                        if (ad.length > 0) {
                            if (c) {
                                ah = (S / ad[0].naturalWidth) / A;
                                ad[0].style[c] = "scale(" + ah + "," + ah + ")"
                            } else {
                                ad.width(S / A)
                            }
                        }
                ...
                if (n > 0) {
                    var ae = (S / n) / A;
                    i.height(Math.max(aa, Math.min(P, ae)))
                }
                if (!o) {
                    U(L, 0)
                }
            ...
            function W(w) {
                ...
                s = 0;
                o = true;
                i.trigger("change.pixelentity", {slideIdx: w + 1});
                if (d) {
                    L = ac;
                    U(ac, V.transition)
                } else {
            ...
            function U(ad, w) {
                ad = -ad;
                if (c) {
                    if (d && typeof w !== "undefined") {
                        C[d] = w + "ms"
                    }
                    C[c] = l ? "translate3d(" + ad + "%,0,0)" : "translate(" + ad + "%,0)"
                } else {
                    F.css("margin-left", parseInt(ad * (S * H / A) / 100, 10))
                }
            }
            ...
            function m() {
                ...
                var w = Math.min(V.transition, f.now() - y);
                var ad = f.easing.easeOutQuad(0, w, z, ac - z, V.transition);
                L = ad;
                U(ad, 0);
                G();
                if (w < V.transition) {
            ...
            function G() {
                o = false;
                var w = parseInt(t[E].attr("data-delay"), 10) * 1000;
                if (w > 0) {
                    Q = w;
                    if (T) {
                        I()
            ...
            function q(ae) {
                var ad = ae.type;
                var af = ae.originalEvent;
                switch (ad) {
                    case"touchstart":
                        if (af.touches.length > 1 || af.scale && af.scale !== 1) {
                            return
                        }
                        u = af.touches[0].pageX;
                        s = 0;
                        break;
                    case"touchmove":
                        if (af.touches.length > 1 || af.scale && af.scale !== 1) {
            ...
            f.extend(this, {
                bind: r, show: function (w) {
                    W(w - 1)
                }, next: p, prev: M, pause: I, resume: D, resize: B, current: function () {
                    return E
                }, currentPos: function () {
                    return L
                }, destroy: function () {
                    f(window).unbind("resize", X);
                    i.unbind("touchstart touchmove touchend", q).unbind("mouseenter mouseleave", Y).unbind(j.toLowerCase() + "TransitionEnd transitionend", G).data("peVolo", null);
                    i = undefined
                }
            });
            f.pixelentity.preloader.load(i, K)
        }

        f.fn.peVolo = function (i) {
            var m = this.data("peVolo");
            if (m) {
                return m
            }
            i = f.extend(true, {}, f.pixelentity.peVolo.conf, i);
            this.each(function () {
                var n = f(this);
                m = new b(n, i);
                n.data("peVolo", m)
    ...
    (function (b) {
        b.pixelentity = b.pixelentity || {version: "1.0.0"};
        b.pixelentity.peVoloSimpleSkin = {conf: {api: false}};
        function a(v, j) {
            var r;
            var q;
            var s, i, e;
            ...
            function c() {
                ...
                if (i) {
                    h = k - i.width() - 12;
                    i.css({top: t - i.height() - 8, left: h}).show();
                    h -= (s.width() - 2);
                    s.css({top: t - s.height() - 8, left: h}).show()
                }
                if (e) {
                    e.css({top: t - e.height() - 12, left: 9}).show()
                }
            }
            ...
            function g(w) {
                ...
                r.show(parseInt(h, 10) + 1);
                return false
            }

            function o(h) {
                if (e) {
                    e.find("a").removeClass("selected").eq(h).addClass("selected")
                }
            }
            ...
            function d() {
                s = b('<div class="peVoloPrev"><a href="#"></a></div>').find("a").click(n).end().hide();
                i = b('<div class="peVoloNext"><a href="#"></a></div>').find("a").click(p).end().hide();
                e = b('<div class="peVoloBullets"></div>').hide();
                for (var h = 0; h < q; h++) {
                    e.append('<a href="#" data-idx="' + h + '"></a>').delegate("a", "click", g)
                }
                o(0);
                v.prepend(s).prepend(i).prepend(e);
                c()
            }
            ...
            function f() {
                r = v.addClass("peVolo").wrapInner('<div class="peWrap"></div>').peVolo({api: true});
                r.bind("ready.pixelentity", m);
                r.bind("resize.pixelentity", u);
                r.bind("change.pixelentity", l)
            }

            b.extend(this, {
                destroy: function () {
                    v.data("peVoloSimpleSkin", null);
                    v = undefined
                }
            });
            f()
        ...
        b.fn.peVoloSimpleSkin = function (c) {
            var d = this.data("peVoloSimpleSkin");
            if (d) {
                return d
            }
            c = b.extend(true, {}, b.pixelentity.peVoloSimpleSkin.conf, c);
            this.each(function () {
                var e = b(this);
                d = new a(e, c);
                e.data("peVoloSimpleSkin", d)
            });
            return c.api ? d : this
        }
    }(jQuery));
    (function (a) {
        a.pixelentity = a.pixelentity || {version: "1.0.0"};
        a.pixelentity.effects = a.pixelentity.effects || {version: "1.0.0"};
        a.pixelentity.effects.iconmove = function (g) {
            ...
            switch (c.data("peScrollThumbDirection")) {
                ...
                case"vertical":
                    ...
                    break;
                default:
                    k = (d - j / 2) * (d - j / 2) > (b - f / 2) * (b - f / 2)
            }
            var i = c.data("icon");
            if (g.type == "mouseenter") {
                if (k) {
                    i.stop().css({left: m, top: 0}).show().delay(100).animate({left: 0}, 200, "easeOutQuad")
                } else {
                    i.stop().css({left: 0, top: l}).show().delay(100).animate({top: 0}, 200, "easeOutQuad")
                }
            } else {
                if (k) {
                    i.stop().css({left: 0, top: 0}).animate({left: m}, 200, "easeOutQuad")
                } else {
                    i.stop().css({left: 0, top: 0}).animate({top: l}, 200, "easeOutQuad")
                }
            }
        }
    }(jQuery));
    (function (d) {
        d.pixelentity = d.pixelentity || {version: "1.0.0"};
        d.pixelentity.twitter = {conf: {username: "", topDate: false, callback: false, count: 3, api: false}};
        var f = d.jStorage;
        var c = {
            url: {
            ...
            user: {from: /@(\w+)/gi, to: '<a href="http://twitter.com/$1" target="_blank">@$1</a>'},
            hash: {
    ...
    (function (c) {
        c.pixelentity = c.pixelentity || {version: "1.0.0"};
        c.pixelentity.flickr = {conf: {userID: "", callback: false, count: 6, cols: 3, api: false}};
        var d = c.jStorage;
        var b = 30 * 60 * 1000;
    ...
    (function (c) {
        ...
        function a(g, h) {
            ...
            function d() {
                f = g.attr("data-default") || "";
                l = g.attr("data-subscribed");
                n = g.is("form") ? g : g.find("form");
                j = n.find('input[name="email"]');
                if (f) {
                    j.val(f).focus(k).focusout(i)
                }
                n.change(k);
                n.submit(m)
            }
            ...
            function e(p) {
                ...
                if (j.val() == f || j.val() == l) {
                    j.val("");
                    j.removeClass("error").closest(".control-group").removeClass("error").removeClass("success");
                    if (!p) {
                        o = false
                    }
                }
                if (o) {
                    if (b.email.test(j.val())) {
                        j.removeClass("error").closest(".control-group").removeClass("error");
                        if (p) {
                            c.post(g.attr("action"), n.serialize(), function (q) {
                                j.removeClass("error").closest(".control-group").addClass("success");
                                j.val(l);
                                if (!f) {
                                    j.one("focus", k)
                                }
                        ...
                        j.addClass("error").closest(".control-group").addClass("error")
                    }
                }
                return false
            }
        ...
        c.fn.peNewsletter = function (d) {
            var e = this.data("peNewsletter");
            if (e) {
                return e
            }
            d = c.extend(true, {}, c.pixelentity.peNewsletter.conf, d);
            this.each(function () {
                var f = c(this);
                e = new a(f, d);
                f.data("peNewsletter", e)
            });
            return d.api ? e : this
        }
    }(jQuery));
    (function (a) {
        a.pixelentity = a.pixelentity || {version: "1.0.0"};
        a.pixelentity.peIsotope = {conf: {api: false}};
        a.Isotope.prototype._fitRowsLayout = function (g) {
            var c = this, f = this.element.width(), d = this.fitRows, e = 0;
            g.each(function () {
                var k = a(this), j = k.outerWidth(true), h = k.outerHeight(true);
                if (j * 1.1 > f) {
                    k.width(f).data("resized", true).addClass("no-transition");
                    j = k.width();
                    h = k.height()
                } else {
                    if (k.data("resized")) {
                        k.css("width", "").data("resized", false).removeClass("no-transition");
                        j = k.width();
                        h = k.height()
                    }
                }
                ...
                var i = parseInt(k.css("margin-left").replace(/px/, ""), 10);
                e = Math.max(e, i);
                if (d.x === 0 && i > 0) {
                    d.x = -i
                }
        ...
        function b(k, l) {
            ...
            function f() {
                e = k.find(".peIsotopeContainer");
                a.pixelentity.preloader.load(e, j)
            }

            function g(o) {
                var n = o.currentTarget.getAttribute("data-category");
                i.removeClass("active").filter(o.currentTarget).addClass("active");
                n = n ? ".filter-" + n : "";
                e.isotope({filter: n});
                return false
            }
            ...
            function j() {
                ...
                i = k.find(".peIsotopeFilter a").click(g);
                setTimeout(d, 500)
            }
            ...
            function d() {
                a(window).bind("smartresize.isotope", h);
                m.reLayout()
            }

            a.extend(this, {
                destroy: function () {
                    k.data("peIsotope", null);
                    k = undefined
                }
            });
            f()
        ...
        a.fn.peIsotope = function (c) {
            var d = this.data("peIsotope");
            if (d) {
                return d
            }
            c = a.extend(true, {}, a.pixelentity.peIsotope.conf, c);
            this.each(function () {
                var e = a(this);
                d = new b(e, c);
                e.data("peIsotope", d)
    ...
    (function (c) {
        ...
        c.pixelentity.gmap = function () {
            ...
            for (var h = 0; h < b.length; h++) {
                k = b[h];
                g = new google.maps.LatLng(k.attr("data-latitude"), k.attr("data-longitude"));
                f = {
                    zoom: parseInt(k.attr("data-zoom"), 10) || 6,
                    center: g,
                    html: k.attr("data-title"),
                    popup: true,
                    mapTypeId: google.maps.MapTypeId.ROADMAP
                };
                l = new google.maps.Map(k[0], f);
                j = new google.maps.InfoWindow({content: k.data("description")});
                e = new google.maps.Marker({position: g, map: l, title: k.attr("data-title")});
        ...
        function a(g, e) {
            ...
            if (f.length > 0) {
                f.each(d);
                c.getScript("http://maps.google.com/maps/api/js?sensor=false&callback=$.pixelentity.gmap&async=2");
                return true
            }
            return false
        }
    ...
    (function (c) {
        ...
        function e(f) {
            if (f.currentTarget.id === "carouselPrev") {
                b.prev()
            } else {
                b.next()
            }
        ...
        function d() {
            var f = c(this);
            b = f.parent().next(".carouselBox");
            if (b.length > 0) {
                b.addClass("peVolo").wrapInner('<div class="peWrap"></div>')
            }
            f.delegate("a", "click", e);
            b = b.peVolo({api: true})
        }

        function a(h, f) {
            var g = h.find(".carousel-nav");
            if (g.length > 0) {
                g.each(d);
                return true
            }
    ...
    (function (b) {
        ...
        pixelentity.classes.Controller = function () {
            ...
            var l = b(window);
            var i = b("body,html");
            var f = b("header ul.nav > li > ul");

            function h(o) {
                var p = o.split(/\//).pop();
                var n = b("header ul.nav");
                n.find('a[href$="' + p + '"]').parents("li").addClass("active")
            }

            function e(m) {
                var n = l.scrollTop();
                j[n > 100 ? "removeClass" : "addClass"]("disabled")
            }

            function c(m) {
                var s = f.eq(m);
                var p, r = s.find("ul.sub-menu").removeClass("rightAlign");
                var n = l.width();
                var o = s.width() + s.parent().offset().left;
                if (o >= n) {
                    s.addClass("rightAlign")
                } else {
                    for (var q = 0; q < r.length; q++) {
                        p = r.eq(q);
                        if (o + p.width() > n) {
                            p.addClass("rightAlign")
                        }
                    }
                }
            }
            ...
            function g() {
                f.removeClass("rightAlign").each(c)
            }

            function k() {
                i.animate({scrollTop: 0}, 500);
                return false
            }

            function d() {
                if (b.pixelentity.browser.mobile) {
                    b("html").addClass("mobile")
                }
                h(location.href);
                if (!b.pixelentity.browser.mobile) {
                    j.click(k);
                ...
                b('.navbar ul.nav a[href="#"]').click(a);
                b.pixelentity.widgets.build(b("body"), {});
                if (b("pre.prettyprint").length > 0) {
                    prettyPrint()
                }
                l.resize(g);
                g()
