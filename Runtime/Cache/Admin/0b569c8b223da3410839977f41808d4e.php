...
<div class="main-container" id="main-container">
    ...
    <div class="btn-group">
		...
		<button class="btn btn-sm btn-primary ajax-post confirm" target-form="ids" url="<?php echo U('del');?>">删 除</button>
    </div>
	<!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Action/edit?id='.$vo['id']);?>">详细</a>
				<a class="confirm ajax-get" href="<?php echo U('Action/del?ids='.$vo['id']);?>">删除</a>
                </td>
