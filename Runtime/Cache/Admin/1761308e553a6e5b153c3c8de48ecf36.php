    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["dircount"]); ?></td>
                        <td>
                            <?php switch($vo["status"]): case "0": ?><a href="<?php echo U('mobileUse?name='.$vo['name']);?>" class="ajax-get">
                                        启用(手机)
                                    </a>
                                    |
                                    <a href="<?php echo U('webUse?name='.$vo['name']);?>" class="ajax-get">
                                        启用(网站)
                                    </a><?php break;?>
                                <?php case "1": ?><a href="<?php echo U('mobileUse?name='.$vo['name']);?>" class="ajax-get">
                                        启用(手机)
                                    </a>
                                    |已启用(网站)<?php break;?>
                                <?php case "2": ?>已启用(手机)|
                                ...
                                <?php case "3": ?>已启用(手机)｜已启用(网站)<?php break;?>
